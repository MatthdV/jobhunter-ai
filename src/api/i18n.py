...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "channel_linkedin_dm": "DM LinkedIn",
        ...
        "dm_section_title": "Message LinkedIn (envoi manuel)",
        "dm_sent_badge": "DM envoyé le",
        "dm_invite_label": "Note d'invitation (max 300 caractères)",
        "dm_message_label": "Message une fois connecté (ou InMail)",
        "dm_copy_invite": "Copier la note",
        "dm_copy_message": "Copier le message",
        "dm_ai_warning": "⚠ Brouillon généré par IA — relis chaque ligne avant de l'envoyer. L'envoi reste 100 % manuel, depuis ton compte LinkedIn.",
        "dm_open_profile": "Ouvrir le profil LinkedIn",
        "dm_mark_sent": "Marquer comme envoyé",
        "dm_mark_sent_confirm": "Marquer ce DM comme envoyé sur LinkedIn ?",
        "dm_draft_btn": "Générer un DM LinkedIn",
        "dm_pitch": "L'IA rédige la note d'invitation et le message — tu les colles toi-même sur LinkedIn. Zéro automatisation, zéro risque pour ton compte.",
    ...
    "en": {
        ...
        "channel_linkedin_dm": "LinkedIn DM",
        ...
        "dm_section_title": "LinkedIn message (manual send)",
        "dm_sent_badge": "DM sent on",
        "dm_invite_label": "Connection note (max 300 characters)",
        "dm_message_label": "Message once connected (or InMail)",
        "dm_copy_invite": "Copy note",
        "dm_copy_message": "Copy message",
        "dm_ai_warning": "⚠ AI-generated draft — reread every line before sending. Sending stays 100% manual, from your own LinkedIn account.",
        "dm_open_profile": "Open LinkedIn profile",
        "dm_mark_sent": "Mark as sent",
        "dm_mark_sent_confirm": "Mark this DM as sent on LinkedIn?",
        "dm_draft_btn": "Generate a LinkedIn DM",
        "dm_pitch": "The AI writes the connection note and the message — you paste them on LinkedIn yourself. Zero automation, zero risk for your account.",
        ...
        "lbl_countries": "Countries (ISO codes)",
        "work_mode_remote": "Remote",
    ...
    "es": {
        ...
        "channel_linkedin_dm": "MD de LinkedIn",
        ...
        "dm_section_title": "Mensaje de LinkedIn (envío manual)",
        "dm_sent_badge": "MD enviado el",
        "dm_invite_label": "Nota de invitación (máx. 300 caracteres)",
        "dm_message_label": "Mensaje una vez conectados (o InMail)",
        "dm_copy_invite": "Copiar la nota",
        "dm_copy_message": "Copiar el mensaje",
        "dm_ai_warning": "⚠ Borrador generado por IA — relee cada línea antes de enviarlo. El envío es 100 % manual, desde tu propia cuenta de LinkedIn.",
        "dm_open_profile": "Abrir el perfil de LinkedIn",
        "dm_mark_sent": "Marcar como enviado",
        "dm_mark_sent_confirm": "¿Marcar este MD como enviado en LinkedIn?",
        "dm_draft_btn": "Generar un MD de LinkedIn",
        "dm_pitch": "La IA redacta la nota de invitación y el mensaje — tú los pegas en LinkedIn. Cero automatización, cero riesgo para tu cuenta.",
        ...
        "lbl_countries": "Países (códigos ISO)",
